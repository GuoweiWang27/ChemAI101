...
const translations: Translations = {
  en: {
    ...
    homeSubline: "An AI chemistry assistant built for real classrooms — phenomenon interpretation · reaction prediction · molecule building · structure lookup",
  ...
  zh: {
    ...
    homeSubline: "为真实化学课堂打造的 AI 化学助手 —— 现象解读 · 反应预测 · 分子搭建 · 结构检索",
