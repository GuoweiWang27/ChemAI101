...
const translations: Translations = {
  en: {
    ...
    reactionTrayNav: "Reaction Tray",
    reactionTrayKicker: "Playable lab · 20 levels",
    reactionTrayTitle: "Reaction Tray",
    reactionTrayDescription: "Layered cards, reaction slots and chemistry conditions in one puzzle.",
  ...
  zh: {
    ...
    reactionTrayNav: "反应槽",
    reactionTrayKicker: "可玩实验 · 20 关",
    reactionTrayTitle: "反应槽 · Reaction Tray",
    reactionTrayDescription: "叠层取牌、反应槽与化学条件组合成一局解谜。",
