...
const translations: Translations = {
  en: {
    ...
    flowStepBackBtn: "Previous beat",
    flowStepForwardBtn: "Next beat",
    flowSpeedLabel: "Speed",
    flowTimelineLabel: "Reaction timeline",
    flowStageLabel: "Current beat",
    flowStatusLabel: "Live explanation",
    flowCompleteLabel: "Reaction complete",
  ...
  zh: {
    ...
    flowStepBackBtn: "上一节拍",
    flowStepForwardBtn: "下一节拍",
    flowSpeedLabel: "速度",
    flowTimelineLabel: "反应时间轴",
    flowStageLabel: "当前节拍",
    flowStatusLabel: "实时讲解",
    flowCompleteLabel: "反应完成",
