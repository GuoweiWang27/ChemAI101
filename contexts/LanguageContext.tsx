...
const translations: Translations = {
  en: {
    ...
    flagshipBadge: "Classroom flagship",
    flagshipDemo: "Classroom demonstration",
    macroPhenomenon: "Macro phenomenon",
    microMechanism: "Microscopic mechanism",
    classroomPausePoint: "Classroom pause point",
    expandHint: "Expand hint",
    hideHint: "Hide hint",
    replayStage: "Replay this stage",
    previousStage: "Previous stage",
    nextStage: "Next stage",
    currentStage: "Current stage",
    trackSwitcher: "Track switcher",
    stageTimeline: "Stage timeline",
    autoPauseLabel: "Auto-pause at prompts",
    observedAtomLabel: "Observed atom",
    navProject: "Project",
    projectStoryTitle: "How ChemAI101 is built",
    projectStoryIntro: "A factual view of the classroom reaction visualization project.",
    projectWhyTitle: "Why",
    projectWhyBody: "Textbook phenomena, equations and microscopic explanations are often shown apart; this project connects them in one teaching sequence.",
    projectMethodTitle: "How",
    projectMethodBody: "A data-driven scene v3 timeline synchronizes macro phenomena, microscopic events, equation cues and teaching pause points.",
    projectQualityTitle: "Quality gates",
    projectBoundaryTitle: "Current boundary",
    projectTeacherPending: "Teacher classroom review pending",
    projectEducationalBoundary: "Animations are educational abstractions, not real experiment videos, scale or reaction rates.",
    projectRepositoryFacts: "Repository audit facts · 2026-08-27",
    projectProfiles: "reaction profiles",
    projectFlows: "reaction flows",
    projectCompleteMappings: "complete mappings",
    projectFlagships: "classroom flagships",
    projectAtomConservation: "atom conservation",
    ...
    curatedEmpty: "Published textbook reactions are temporarily unavailable.",
    backBtn: "Back",
    demoBtn: "Present",
    qrBtn: "QR Code",
    ...
    curatedIntro: "Classic reactions from the PEP high-school textbook, organized for classroom explanation. Teacher review status is shown separately.",
    ...
    homeCardCuratedDesc: "PEP textbook classics — published reaction explanations",
    ...
    homeReadyReactions: "{{count}} published textbook reactions",
    homeReviewBadge: "Teacher classroom review pending",
  ...
  zh: {
    ...
    flagshipBadge: "课堂旗舰",
    flagshipDemo: "课堂演示",
    macroPhenomenon: "宏观现象",
    microMechanism: "微观机理",
    classroomPausePoint: "课堂暂停点",
    expandHint: "展开提示",
    hideHint: "收起提示",
    replayStage: "重播本阶段",
    previousStage: "上一阶段",
    ...
    trackSwitcher: "轨道切换",
    stageTimeline: "阶段时间轴",
    autoPauseLabel: "节点自动暂停",
    observedAtomLabel: "当前观察原子",
    navProject: "项目说明",
    projectStoryTitle: "ChemAI101 如何做成",
    projectStoryIntro: "用事实说明这个课堂反应可视化项目的目标、架构与当前边界。",
    projectWhyTitle: "为什么做",
    projectWhyBody: "教材现象、方程式和微观解释经常被分开呈现；这个项目把它们连接成一段可讲解的课堂顺序。",
    projectMethodTitle: "怎么做",
    projectMethodBody: "用数据驱动的 scene v3 时间轴，同步宏观现象、微观事件、方程式提示和课堂暂停点。",
    projectQualityTitle: "质量门禁",
    projectBoundaryTitle: "当前边界",
    projectTeacherPending: "教师课堂复核待完成",
    projectEducationalBoundary: "动画是教学抽象，不是真实实验视频，也不代表真实比例或反应速率。",
    projectRepositoryFacts: "仓库审计事实 · 2026-08-27",
    projectProfiles: "个反应 profile",
    projectFlows: "个反应流程",
    projectCompleteMappings: "个完整映射",
    projectFlagships: "个课堂旗舰",
    projectAtomConservation: "原子守恒",
    ...
    curatedIntro: "按人教版教材章节整理的典型反应，用于课堂讲解；教师审核状态单独记录。",
